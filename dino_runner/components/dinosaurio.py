...
from dino_runner.utils.constants import RUNNING, JUMPING, DUCKING , DEAD , RUNNING_SHIELD , JUMPING_SHIELD ,DUCKING_SHIELD , DEFAULT_TYPE, SHIELD_TYPE , RUN_HAMMER, HAMMER_TYPE,JUMPING_HAMMER, DUCKING_HAMMER,HEART_TYPE

#PARA CORRER CON O SIN PODER 
RUN_IMG = {DEFAULT_TYPE:RUNNING, SHIELD_TYPE:RUNNING_SHIELD , HAMMER_TYPE:RUN_HAMMER , HEART_TYPE:RUNNING}
JUMO_IMG ={DEFAULT_TYPE: JUMPING , SHIELD_TYPE: JUMPING_SHIELD , HAMMER_TYPE:JUMPING_HAMMER, HEART_TYPE:JUMPING}
